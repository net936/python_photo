...
class Thing(models.Model):
    ...
    location = models.CharField(max_length=100, blank=True, null=True)  # 拍摄地点
    wxts = models.CharField(max_length=100, blank=True, null=True)
    status = models.CharField(max_length=1, choices=STATUS_CHOICES, default='0')
    create_time = models.DateTimeField(auto_now_add=True, null=True)
...
class Order(models.Model):
    ...
    receiver_time = models.CharField(max_length=50, blank=True, null=True)  # 预约时间
